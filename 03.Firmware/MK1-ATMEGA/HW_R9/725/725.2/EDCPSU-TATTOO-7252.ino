...
#define VERSION 7252
/*********************************************************************
EDCPSU Tattoo edition HW r9.0
Oct 2021
Modifications to remove OVCAlarmDetected
Modifications to enlarge Overcurrent time detection
Serial library removed
CHG_POL canibalized to flag the overcurrent event for debugging (40ms burst = overcurrent)
