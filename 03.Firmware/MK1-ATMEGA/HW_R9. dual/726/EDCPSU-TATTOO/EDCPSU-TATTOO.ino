...
const int OVC_SENSE_MAX_TIME  = 700;         // Maximum time that can last the overcurrent with SENSE method (in Milliseconds)
const int OVC_UVOLT_MAX_TIME  = 1000;        // Maximum time that can last the overcurrent with the UNDERVOLTAGE method (Milliseconds)
const int OVC_SENSE_LIMIT_INF = 600;         // Current limit above which it is still considered an overcurrent sense situation 2.34A
const int OVC_SENSE_LIMIT_SUP = 800;         // Current limit above which it is Triggered the overcurrent sense situation 3.125A
...
131,67,35,163,227,19,147,83,211,51,179,115,243,139,75,203,43,171,107,235,155,91,219,123,251,7,135,199
}; //OVERDRIVE version (+0.4v)
    ...
    while(inputsSTOP == false)
    {
      if(digitalRead(PUSHBUTTON_IP)  == PUSHBUTTON_OFF)
      {
        if(digitalRead(PEDAL_IP)     == PUSHBUTTON_OFF)
        {
          ...
          else {DisplayMessage(RunMode, WRITE_MESSG, "PLEASE, STOP BUTTONS", INFO_MESSG, 150);}
        }
        else {DisplayMessage(RunMode, WRITE_MESSG, "PLEASE, STOP BUTTONS", INFO_MESSG, 150);}
      }
      else {DisplayMessage(RunMode, WRITE_MESSG, "PLEASE, STOP BUTTONS", INFO_MESSG, 150);}   
